...
/**
 * Extension interface allowing command provider to be called in a generic
 * fashion just before, and right after, executing a command.
 * 
 * @author Costin Leau
 */
public interface ExecutionProcessor extends CommandMarker {
	 ...
	 * {@link ParseResult}). Additionally, for advanced cases, the parse result
	 * itself effectively changing the invocation calling site.
	 * 
	...
	/**
	 * Method called after successfully invoking the target command (described
	 * by {@link ParseResult}).
	 * 
	 * @param invocationContext
	 *            target command context
	 ...
	 * {@link ParseResult}) had thrown an exception .
	 * 
	 * @param invocationContext
	 *            target command context
	 * @param thrown

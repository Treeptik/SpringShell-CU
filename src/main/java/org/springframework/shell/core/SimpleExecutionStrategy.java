...
/**
 * Simple execution strategy for invoking a target method. Supports pre/post
 * processing to allow {@link CommandMarker}s for aop-like behavior ( typically
 * used for controlling stateful objects).
 * 
 * @author Mark Pollack
 * @author Costin Leau
 */
public class SimpleExecutionStrategy implements ExecutionStrategy {
	...
	private static final Logger logger = HandlerUtils
			.getLogger(SimpleExecutionStrategy.class);

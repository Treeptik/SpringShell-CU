...
public abstract class AbstractShell extends AbstractShellStatusPublisher
	 ...
	 * of <i>toString</i> is shown. Subclasses can alter this implementation to
	 * handle the <i>result</i> differently.
	 * 
	 * @param result
	 *            not <code>null</code> result of execution of a command.
	 */

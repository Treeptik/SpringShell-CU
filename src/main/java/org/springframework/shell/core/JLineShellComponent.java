 ...
 * @since 1.1
 */
public class JLineShellComponent extends JLineShell implements SmartLifecycle,
	...
	public void afterPropertiesSet() {
		...
		Map<String, CommandMarker> commands = BeanFactoryUtils
	...
	protected String getHistoryFileName() {
		HistoryFileNameProvider historyFileNameProvider = PluginUtils
				.getHighestPriorityProvider(this.applicationContext,
						HistoryFileNameProvider.class);
		String providerHistoryFileName = historyFileNameProvider
				.getHistoryFileName();
	...
	protected String getPromptText() {
		PromptProvider promptProvider = PluginUtils.getHighestPriorityProvider(
				this.applicationContext, PromptProvider.class);
	 ...
	 * order <link>org.springframework.core.Ordered.getOder</link> will win.
	 * 
	 * @return BannerText[0]: Banner BannerText[1]: Welcome Message
	 *         BannerText[2]: Version BannerText[3]: Product Name
	 */
	private String[] getBannerText() {
		String[] bannerText = new String[4];
		BannerProvider provider = PluginUtils.getHighestPriorityProvider(
				this.applicationContext, BannerProvider.class);

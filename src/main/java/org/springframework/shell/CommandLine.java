...
public class CommandLine {
	 ...
	 * 
	 * @param args
	 *            an array of strings from main(String[] args)
	 * @param historySize
	 *            the size of this history buffer
	 * @param shellCommandsToExecute
	 *            semi-colon delimited list of commands for the shell to execute
	 */
	public CommandLine(String[] args, int historySize,
